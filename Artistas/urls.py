...
from Artistas.views import searchGrungeAlbum, searchGrungeAlbum_result
from Artistas.views import searchPunkArtist, searchPunkArtist_result
from Artistas.views import searchPunkAlbum, searchPunkAlbum_result
from Artistas.views import searchFunkAlbum, searchFunkAlbum_result
...
urlpatterns = [
    ...
    path('searchGrungeAlbum/', searchGrungeAlbum, name='searchGrungeAlbum'),
    path('searchGrungeAlbum_result/', searchGrungeAlbum_result, name='searchGrungeAlbum_result'),
    path('searchPunkArtist/', searchPunkArtist, name='searchPunkArtist'),
    path('searchPunkArtist_result/', searchPunkArtist_result, name='searchPunkArtist_result'),
    path('searchPunkAlbum/', searchPunkAlbum, name='searchPunkAlbum'),
    path('searchPunkAlbum_result/', searchPunkAlbum_result, name='searchPunkAlbum_result'),
    path('searchFunkAlbum/', searchFunkAlbum, name='searchFunkAlbum'),
    path('searchFunkAlbum_result/', searchFunkAlbum_result, name='searchFunkAlbum_result'),
